...
dataId = (addZero(dataH.getDate()) + " - " + addZero(dataH.getMonth() + 1) + " - " + (dataH.getFullYear()) + " - " + addZero(dataH.getHours()) + "h:" + addZero(dataH.getMinutes()) + ":" + addZero(dataH.getSeconds()))
    ...
    atualizar(id) {
        ...
        for (let i = 0; i < this.arrayMoeda.length; i++) {
            if (id == this.arrayMoeda[i].id) {
                ...
                this.arrayMoeda[i].operacao = document.getElementById("tipoOperação").value;
                this.arrayMoeda[i].quantidade = document.getElementById("quantidadeMoeda").value
            }
        }
